...
{
	public class Pierce_Defence : IDefence
	{
		private Defence_Value defence_Value;

		public Pierce_Defence(Defence_Value defence_Value)
		{
			this.defence_Value = defence_Value;
		}

		public Defence_Value Defence_Value { get => defence_Value; set => defence_Value = value; }

		public bool Is_Valid(IDamage damage)
		{
			return damage is Pierce_Damage;
		}
